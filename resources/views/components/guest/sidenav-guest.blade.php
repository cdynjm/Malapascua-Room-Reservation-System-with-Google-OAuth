    ...
    <div class="container-fluid px-1">
        ...
        <div class="collapse navbar-collapse" id="navigation">
            <ul class="navbar-nav mx-auto ms-xl-auto">
                <li class="nav-item">
                    <a wire:navigate class="nav-link d-flex align-items-center me-2 {{ is_current_route('sign-up') ? 'active' : '' }}"
                        href="{{ route('sign-up') }}">
                ...
                <li class="nav-item">
                    <a wire:navigate class="nav-link d-flex align-items-center me-2 {{ is_current_route('sign-in') ? 'active' : '' }}"
                        href="{{ route('sign-in') }}">
                        <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                            fill="currentColor" class="me-1">
                            <path fill-rule="evenodd"
            ...
            <ul class="navbar-nav d-lg-block d-none">
                <li class="nav-item">
                    <a href="#" target="_blank"
                        class="btn btn-sm mb-0 bg-gradient-dark">MRR</a>
                </li>
            </ul>
        </div>
    </div>
